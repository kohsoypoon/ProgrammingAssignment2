## It is an R function to cache the inverse of a matrix. It is useful and save time when the dimension of the matrix is large and
...
## cache. Subsequently, when it is again needed, computation is no longer required as it can be retrieved from cache.  
## In this manner, processing time could be minimised.  
